<html>
	...
	.quo{ font-size:25px ; line-height:25px ; font-family:fantasy ; position:absolute ; color:white ; top:50px ; left:50px ; z-index:1 ; 
		padding:50px 900px 40px 80px ; letter-spacing:0.0001em ; text-align:center ; word-spacing:5px ; color:rgb(148,0,211)}
...
?>
	...
	<img src="education1.jpg" class="image">

	<div class="quo" style="text-align:left ;margin-top:-30px ; color:rgb(147,112,219)">
		<p style="font-size:25px ; color:white "><u>AREAS OF INVESTMENTS</u></p>		
		<p style="font-size:25px ">MAHARASHTRA:<span style="color:rgb(255,0,255) ; font-size:40px">&nbsp;<?PHP echo round($n1,2); ?>&nbsp;%</span></p>
		<p style="font-size:25px ">KERELA:<span style="color:rgb(255,0,255) ; font-size:40px">&nbsp;<?PHP echo round($n2,2); ?>&nbsp;%</span></p>		
		<p style="font-size:25px ">RAJASTHAN:<span style="color:rgb(255,0,255) ; font-size:40px">&nbsp;<?PHP echo round($n3,2); ?>&nbsp;%</span></p>
		<p style="font-size:25px ">UTTAR PRADESH:<span style="color:rgb(255,0,255) ; font-size:40px">&nbsp;<?PHP echo round($n4,2); ?>&nbsp;%</span></p>
		<p style="font-size:25px ">WEST BENGAL:<span style="color:rgb(255,0,255) ; font-size:40px">&nbsp;<?PHP echo round($n5,2); ?>&nbsp;%</span></p>
		<p style="font-size:25px ">OTHER:<span style="color:rgb(255,0,255) ; font-size:40px">&nbsp;<?PHP echo round($n6,2); ?>&nbsp;%</span></p>
	</div>
      <div class="i">
	...
	<div class="quo" style="left:720px ; margin-top:50px ; padding-right:250px ;">
	   <p style="color:white">INVESTMENTS</p>
		...
		<p style="font-size:20px ; color:white">recieved<span style="color:rgb(255,0,255) ; font-size:40px">&emsp;<?PHP echo $sum1; ?></span></p>
		<p style="font-size:20px ; color:white">used<span style="color:rgb(255,0,255) ; font-size:40px">&emsp;<?PHP echo $sum2; ?></span></p>
	</div>
	<div class="i" style="left:650px">
		
		<svg style="height:480px ; fill:rgb(148,0,211) ; opacity:0.5">
